...
> 精确公式与实现：[查看 `Super_Baby` 公式页](../skill-formulas/Super_Baby.md)
...
| 2 | `SM_SWORD` | Sword Mastery | 10 | Super_Baby | 是 | — | Weapon / Passive |
| 4 | `SM_RECOVERY` | Increase HP Recovery | 10 | Super_Baby | 是 | — | None / Passive |
| 5 | `SM_BASH` | Bash | 10 | Super_Baby | 是 | — | Weapon / Attack |
| 6 | `SM_PROVOKE` | Provoke | 10 | Super_Baby | 是 | — | None / Attack |
| 7 | `SM_MAGNUM` | Magnum Break | 10 | Super_Baby | 是 | SM_BASH Lv5 | Weapon / Self |
| 8 | `SM_ENDURE` | Endure | 10 | Super_Baby | 是 | SM_PROVOKE Lv5 | Weapon / Self |
| 9 | `MG_SRECOVERY` | Increase SP Recovery | 10 | Super_Baby | 是 | — | None / Passive |
| 10 | `MG_SIGHT` | Sight | 1 | Super_Baby | 是 | — | Magic / Self |
| 11 | `MG_NAPALMBEAT` | Napalm Beat | 10 | Super_Baby | 是 | — | Magic / Attack |
| 12 | `MG_SAFETYWALL` | Safety Wall | 10 | Super_Baby | 是 | MG_NAPALMBEAT Lv7, MG_SOULSTRIKE Lv5 | Magic / Ground |
| 13 | `MG_SOULSTRIKE` | Soul Strike | 10 | Super_Baby | 是 | MG_NAPALMBEAT Lv4 | Magic / Attack |
| 14 | `MG_COLDBOLT` | Cold Bolt | 10 | Super_Baby | 是 | — | Magic / Attack |
| 15 | `MG_FROSTDIVER` | Frost Diver | 10 | Super_Baby | 是 | MG_COLDBOLT Lv5 | Magic / Attack |
| 16 | `MG_STONECURSE` | Stone Curse | 10 | Super_Baby | 是 | — | Magic / Attack |
| 17 | `MG_FIREBALL` | Fire Ball | 10 | Super_Baby | 是 | MG_FIREBOLT Lv4 | Magic / Attack |
| 18 | `MG_FIREWALL` | Fire Wall | 10 | Super_Baby | 是 | MG_FIREBALL Lv5, MG_SIGHT Lv1 | Magic / Ground |
| 19 | `MG_FIREBOLT` | Fire Bolt | 10 | Super_Baby | 是 | — | Magic / Attack |
| 20 | `MG_LIGHTNINGBOLT` | Lightning Bolt | 10 | Super_Baby | 是 | — | Magic / Attack |
| 21 | `MG_THUNDERSTORM` | Thunderstorm | 10 | Super_Baby | 是 | MG_LIGHTNINGBOLT Lv4 | Magic / Ground |
| 22 | `AL_DP` | Divine Protection | 10 | Super_Baby | 是 | — | Weapon / Passive |
| 23 | `AL_DEMONBANE` | Demon Bane | 10 | Super_Baby | 是 | AL_DP Lv3 | Weapon / Passive |
| 24 | `AL_RUWACH` | Ruwach | 1 | Super_Baby | 是 | — | Magic / Self |
| 25 | `AL_PNEUMA` | Pneuma | 1 | Super_Baby | 是 | AL_WARP Lv4 | Magic / Ground |
| 26 | `AL_TELEPORT` | Teleport | 2 | Super_Baby | 是 | AL_RUWACH Lv1 | Magic / Self |
| 27 | `AL_WARP` | Warp Portal | 4 | Super_Baby | 是 | AL_TELEPORT Lv2 | Magic / Ground |
| 28 | `AL_HEAL` | Heal | 10 | Super_Baby | 是 | — | Magic / Support |
| 29 | `AL_INCAGI` | Increase AGI | 10 | Super_Baby | 是 | AL_HEAL Lv3 | Magic / Support |
| 30 | `AL_DECAGI` | Decrease AGI | 10 | Super_Baby | 是 | AL_INCAGI Lv1 | Magic / Attack |
| 31 | `AL_HOLYWATER` | Aqua Benedicta | 1 | Super_Baby | 是 | — | Magic / Self |
| 32 | `AL_CRUCIS` | Signum Crucis | 10 | Super_Baby | 是 | AL_DEMONBANE Lv3 | Magic / Self |
| 33 | `AL_ANGELUS` | Angelus | 10 | Super_Baby | 是 | AL_DP Lv3 | Magic / Self |
| 34 | `AL_BLESSING` | Blessing | 10 | Super_Baby | 是 | AL_DP Lv5 | Magic / Support |
| 35 | `AL_CURE` | Cure | 1 | Super_Baby | 是 | — | Magic / Support |
| 36 | `MC_INCCARRY` | Enlarge Weight Limit | 10 | Super_Baby | 是 | — | None / Passive |
| 37 | `MC_DISCOUNT` | Discount | 10 | Super_Baby | 是 | MC_INCCARRY Lv3 | None / Passive |
| 38 | `MC_OVERCHARGE` | Overcharge | 10 | Super_Baby | 是 | MC_DISCOUNT Lv3 | None / Passive |
| 39 | `MC_PUSHCART` | Pushcart | 10 | Super_Baby | 是 | MC_INCCARRY Lv5 | None / Passive |
| 40 | `MC_IDENTIFY` | Item Appraisal | 1 | Super_Baby | 是 | — | None / Self |
| 41 | `MC_VENDING` | Vending | 10 | Super_Baby | 是 | MC_PUSHCART Lv3 | None / Self |
| 42 | `MC_MAMMONITE` | Mammonite | 10 | Super_Baby | 是 | — | Weapon / Attack |
| 43 | `AC_OWL` | Owl's Eye | 10 | Super_Baby | 是 | — | None / Passive |
| 44 | `AC_VULTURE` | Vulture's Eye | 10 | Super_Baby | 是 | AC_OWL Lv3 | None / Passive |
| 45 | `AC_CONCENTRATION` | Improve Concentration | 10 | Super_Baby | 是 | AC_VULTURE Lv1 | Weapon / Self |
| 48 | `TF_DOUBLE` | Double Attack | 10 | Super_Baby | 是 | — | Weapon / Passive |
| 49 | `TF_MISS` | Improve Dodge | 10 | Super_Baby | 是 | — | Weapon / Passive |
| 50 | `TF_STEAL` | Steal | 10 | Super_Baby | 是 | — | Weapon / Attack |
| 51 | `TF_HIDING` | Hiding | 10 | Super_Baby | 是 | TF_STEAL Lv5 | None / Self |
| 52 | `TF_POISON` | Envenom | 10 | Super_Baby | 是 | — | Weapon / Attack |
| 53 | `TF_DETOXIFY` | Detoxify | 1 | Super_Baby | 是 | TF_POISON Lv3 | Weapon / Support |
| 2535 | `ALL_BUYING_STORE` | Open Buying Store | 1 | Super_Baby | 是 | MC_VENDING Lv1 | None / Self |
| 2544 | `MC_CARTDECORATE` | Decorate Cart | 1 | Super_Baby | 是 | — | None / Self |
