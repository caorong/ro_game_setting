...
> 精确公式与实现：[查看 `Lord_Knight2` 公式页](../skill-formulas/Lord_Knight2.md)
...
| 355 | `LK_AURABLADE` | Aura Blade | 5 | Lord_Knight | 否 | SM_BASH Lv5, SM_MAGNUM Lv5, SM_TWOHAND Lv5 | Weapon / Self |
| 356 | `LK_PARRYING` | Parrying | 10 | Lord_Knight | 否 | SM_TWOHAND Lv10, SM_PROVOKE Lv5, KN_TWOHANDQUICKEN Lv3 | Weapon / Self |
| 357 | `LK_CONCENTRATION` | Concentration | 5 | Lord_Knight | 否 | SM_RECOVERY Lv5, KN_SPEARMASTERY Lv5, KN_RIDING Lv1 | Weapon / Self |
| 358 | `LK_TENSIONRELAX` | Relax | 1 | Lord_Knight | 否 | SM_RECOVERY Lv10, SM_PROVOKE Lv5, SM_ENDURE Lv3 | Weapon / Self |
| 359 | `LK_BERSERK` | Frenzy | 1 | Lord_Knight | 否 | — | Weapon / Self |
| 397 | `LK_SPIRALPIERCE` | Spiral Pierce | 5 | Lord_Knight | 否 | KN_SPEARMASTERY Lv10, KN_PIERCE Lv5, KN_SPEARSTAB Lv5, KN_RIDING Lv1 | Weapon / Attack |
| 398 | `LK_HEADCRUSH` | Traumatic Blow | 5 | Lord_Knight | 否 | KN_SPEARMASTERY Lv9, KN_RIDING Lv1 | Weapon / Attack |
| 399 | `LK_JOINTBEAT` | Vital Strike | 10 | Lord_Knight | 否 | KN_SPEARMASTERY Lv9, KN_CAVALIERMASTERY Lv3, LK_HEADCRUSH Lv3 | Weapon / Attack |
