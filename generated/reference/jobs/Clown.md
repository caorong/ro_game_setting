...
| 315 | `BA_MUSICALLESSON` | Music Lessons | 10 | Bard | 否 | — | Weapon / Passive |
| 316 | `BA_MUSICALSTRIKE` | Melody Strike | 5 | Bard | 否 | BA_MUSICALLESSON Lv3 | Weapon / Attack |
| 317 | `BA_DISSONANCE` | Unchained Serenade | 5 | Bard | 否 | BA_MUSICALLESSON Lv1, BD_ADAPTATION Lv1 | Misc / Self |
| 318 | `BA_FROSTJOKER` | Unbarring Octave | 5 | Bard | 否 | BD_ENCORE Lv1 | Misc / Self |
| 319 | `BA_WHISTLE` | Perfect Tablature | 10 | Bard | 否 | BA_DISSONANCE Lv3 | Misc / Self |
| 320 | `BA_ASSASSINCROSS` | Impressive Riff | 10 | Bard | 否 | BA_DISSONANCE Lv3 | Misc / Self |
| 321 | `BA_POEMBRAGI` | Magic Strings | 10 | Bard | 否 | BA_DISSONANCE Lv3 | Misc / Self |
| 322 | `BA_APPLEIDUN` | Song of Lutie | 10 | Bard | 否 | BA_DISSONANCE Lv3 | Misc / Self |
| 304 | `BD_ADAPTATION` | Amp | 1 | Bard | 否 | — | None / Self |
| 305 | `BD_ENCORE` | Encore | 1 | Bard | 否 | BD_ADAPTATION Lv1 | None / Self |
| 306 | `BD_LULLABY` | Lullaby | 1 | Bard | 否 | BA_WHISTLE Lv10 | Misc / Self |
| 307 | `BD_RICHMANKIM` | Mental Sensing | 5 | Bard | 否 | BD_SIEGFRIED Lv3 | Misc / Self |
| 308 | `BD_ETERNALCHAOS` | Down Tempo | 1 | Bard | 否 | BD_ROKISWEIL Lv1 | Misc / Self |
| 309 | `BD_DRUMBATTLEFIELD` | Battle Theme | 5 | Bard | 否 | BA_APPLEIDUN Lv10 | Misc / Self |
| 310 | `BD_RINGNIBELUNGEN` | Harmonic Lick | 5 | Bard | 否 | BD_DRUMBATTLEFIELD Lv3 | Misc / Self |
| 311 | `BD_ROKISWEIL` | Classical Pluck | 1 | Bard | 否 | BA_ASSASSINCROSS Lv10 | Misc / Self |
| 312 | `BD_INTOABYSS` | Power Chord | 1 | Bard | 否 | BD_LULLABY Lv1 | Misc / Self |
| 313 | `BD_SIEGFRIED` | Acoustic Rhythm | 5 | Bard | 否 | BA_POEMBRAGI Lv10 | Misc / Self |
| 1010 | `BA_PANGVOICE` | Pang Voice | 1 | Bard | 否 | — | Misc / Attack |
| 394 | `CG_ARROWVULCAN` | Vulcan Arrow | 10 | Clown | 是 | AC_SHOWER Lv5, BA_MUSICALSTRIKE Lv1 | Weapon / Attack |
| 395 | `CG_MOONLIT` | Sheltering Bliss | 5 | Clown | 是 | AC_CONCENTRATION Lv5, BA_MUSICALLESSON Lv7 | Misc / Self |
| 396 | `CG_MARIONETTE` | Marionette Control | 1 | Clown | 是 | AC_CONCENTRATION Lv5, BA_MUSICALLESSON Lv5 | None / Support |
| 487 | `CG_LONGINGFREEDOM` | Longing for Freedom | 5 | Clown | 是 | BA_MUSICALLESSON Lv10, CG_MARIONETTE Lv1 | None / Self |
| 488 | `CG_HERMODE` | Wand of Hermode | 5 | Clown | 是 | AC_CONCENTRATION Lv10, BA_MUSICALLESSON Lv10 | Misc / Self |
| 489 | `CG_TAROTCARD` | Tarot Card of Fate | 5 | Clown | 是 | AC_CONCENTRATION Lv10, BA_DISSONANCE Lv3 | Misc / Attack |
...
- 技能树最高等级：`10`
- 前置技能：AC_SHOWER Lv5, BA_MUSICALSTRIKE Lv1
...
- 技能树最高等级：`5`
- 前置技能：AC_CONCENTRATION Lv5, BA_MUSICALLESSON Lv7
- 公式覆盖：`dedicated-source` / `source-indexed`
...
- 技能树最高等级：`1`
- 前置技能：AC_CONCENTRATION Lv5, BA_MUSICALLESSON Lv5
- 公式覆盖：`dedicated-source` / `source-indexed`
...
- 技能树最高等级：`5`
- 前置技能：BA_MUSICALLESSON Lv10, CG_MARIONETTE Lv1
- 公式覆盖：`dedicated-source` / `source-indexed`
...
- 技能树最高等级：`5`
- 前置技能：AC_CONCENTRATION Lv10, BA_MUSICALLESSON Lv10
- 公式覆盖：`dedicated-source` / `source-indexed`
...
- 技能树最高等级：`5`
- 前置技能：AC_CONCENTRATION Lv10, BA_DISSONANCE Lv3
- 公式覆盖：`dedicated-source` / `source-indexed`
